...
#define CPR 53248.0f//(2048*26)         // Counter Per Revolution
...
float proportional_gain = 4.6f;            // kp
float integral_gain = 0.0f;                // ki
float motor1MaxCurrent=3.0f;
// ────────────── ⏲️ Timing and Sampling ──────────────
float sampling_time = 0.005f;                 // dt_s: Set this appropriately in your loop
...
// PI Controller gains for acceleration control
float motor02_proportional_gain = 4.6f;            // kp
float motor02_integral_gain = 0.0f;                 // ki

// ────────────── ⏲️ Timing and Sampling ──────────────
float motor02_sampling_time = 0.005f;                  // dt_s (set appropriately)
...
void UpdateMotor02CommandedCurrent(void)
{
    ...
    effective_velocity =motor02_motor_velocity;
...
int main(void)
{
  ...
  osThreadDef(MainController, StartTask02, osPriorityHigh, 0, 128);
